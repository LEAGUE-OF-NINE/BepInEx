...
internal static class ProxyAssemblyGenerator
{
    ...
    private static readonly ConfigEntry<string> UnhollowedAssembliesPath = ConfigFile.CoreConfig.Bind(
     "IL2CPP", "UnhollowedAssembliesPath",
     "{BepInEx}",
     new StringBuilder()
         .AppendLine("The path to the folder where unhollowed assemblies are stored.")
    ...
    private static string UnhollowedBasePath
    {
        get
        {
            ...
            var path = Utility.GetCommandLineArgValue("--unhollowed-path") ?? UnhollowedAssembliesPath.Value;
            unhollowedBasePath = path.Replace("{BepInEx}", Paths.BepInExRootPath)
    ...
    public static void GenerateAssemblies()
    {
        ...
        runner.Setup(Paths.ExecutablePath, Paths.BepInExRootPath, Paths.ManagedPath);
                                                ...
                                                IL2CPPDumperType dumperType)
        {
            ...
            else // if (dumperType == IL2CPPDumperType.Cpp2IL)
            {
                ...
                Cpp2IlApi.RunAttributeRestorationForAllAssemblies(null,
                                                                  parallel: LibCpp2IlMain.MetadataVersion >= 29 ||
                                                                            LibCpp2IlMain.Binary!.InstructionSet is
                                                                                InstructionSet.X86_32
